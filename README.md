# Package Library for Interaction with the Pololu 3pi+ 2040 Robot Components
...
* [Line](https://github.com/lf-lang/pololu-3pi-c/blob/main/src/lib/Line.lf): Reads the line sensors when triggered and outputs their values. By default, calibration is performed upon receiving the first trigger. **NOTE**: Using the line sensors together with the bump sensors is generally impractical because they interfere with each other.
